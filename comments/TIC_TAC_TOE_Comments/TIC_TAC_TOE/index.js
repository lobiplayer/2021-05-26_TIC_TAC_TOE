...
// Good job, well done. You can definitely clean up the tiles on click function as it is very repetitive. In coding you should follow the DRY principle, Don't Repeat Yourself. If you are doing the same thing over and over again, find a better way to write it so that you can write it in less code.

// Doing this will make it easier for you to control the end of the game as well, right now when the game ends I can still click on the other tiles.
